...
const BentoTilt = ({children, className = ""}) => {
  ...
  const handleMouseMove = (e) => {
    ...
    rotateY(${tiltY}deg) scale3d(0.97,0.97,0.97)`;
...
const Features = () => {
  return (
    <section className="bg-black pb-52">
      <div className="mx-auto container px-3 md:px-10">
        <div className="px-5 py-32">
          <p className="font-circular-web text-lg text-blue-50">Into the Metagame Layer</p>
          <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
            Immerse yourself in an IP-rich product universe where AI-driven gamification and
          ...
          <div className="bento-tilt_2">
            <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
              <h1 className="bento-title special-font max-w-64 text-black">
                M<b>o</b>re co<b>m</b>ing s<b>oo</b>n<b>!</b>
              </h1>
